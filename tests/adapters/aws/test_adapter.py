...
class TestAWSAdapterDelegation:
    def test_list_resources_calls_resource_explorer(self):
        ...
        with patch("adapters.aws.adapter.resource_explorer.list_resources", return_value=expected) as mock_fn:
    ...
    def test_get_metrics_calls_cloudwatch(self):
        ...
        with patch("adapters.aws.adapter.cloudwatch.get_metrics", return_value=expected) as mock_fn:
    ...
    def test_get_cost_calls_cost_explorer(self):
        ...
        with patch("adapters.aws.adapter.cost_explorer.get_cost", return_value=expected) as mock_fn:
    ...
    def test_get_last_activity_calls_cloudtrail(self):
        ...
        with patch("adapters.aws.adapter.cloudtrail.get_last_activity", return_value=expected) as mock_fn:
...
class TestForAccountClassMethod:
    def test_creates_adapter_via_auth(self):
        ...
        with patch("adapters.aws.adapter.auth.get_session", return_value=mock_session) as mock_auth:
